...
# ; if you want cmd in the same line, if you dont, Enter+tab
deploy-sepolia1:
	forge script script/DeployFundMe.s.sol:DeployFundMe --rpc-url $(SEPOLIA_RPC_URL) --account Dev1 --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv

-include .env

# Tells make these are not folders
